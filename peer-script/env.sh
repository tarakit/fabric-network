...
export  CONFIG_DIRECTORY=$HOME/acme-airline

export FABRIC_CFG_PATH=$HOME/acme-airline
...
export CORE_PEER_FILESYSTEMPATH=$HOME/acme-airline/ledger

# Identity set to Admin
export CORE_PEER_MSPCONFIGPATH=$CONFIG_DIRECTORY/crypto-material/peerOrganizations/acme.com/users/Admin@acme.com/msp
echo "Configured !!"

# State Data persistence in CouchDB
CORE_LEDGER_STATE_STATEDATABASE=CouchDB
# For Couch DB
CORE_LEDGER_STATE_COUCHDBCONFIG_COUCHDBADDRESS=8.208.27.142:5984
